...
const ProductLists = (
    ...
    return (
        ...
        style={{ height: 'auto', width: screenWidth * 0.44, padding: 10, borderWidth: 1, borderRadius: 5, borderColor: colors.Gray_Border, margin: 5 }}>
            ...
            <Text style={{ fontSize: fs(16), color: colors.black, fontFamily: fonts.regular }}>{productName}</Text>
            <Text style={{ fontSize: fs(18), color: colors.black, fontFamily: fonts.bold, fontWeight: '700' }}>{productPrice}</Text>
            </View>
        </Pressable>
    );
};
